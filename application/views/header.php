    ...
    <div class="container-menu-desktop trans-03">
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop p-l-45">
                ...
                <!-- Logo desktop -->
                <a href="<?= base_url() ?>index.php/Coza" class="logo">
                    <img src="<?= base_url() ?>assets/images/icons/logo-02.png" alt="IMG-LOGO">
                </a>
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        <li>
                            <a href="<?= base_url() ?>index.php/Coza">Home</a>
                            <!-- <ul class="sub-menu">
                        ...
                        <li>
                            <a href="<?= base_url('index.php/Shop') ?>">Shop</a>
                        </li>

                        <li class="label1" data-label1="hot">
                            <a href="<?= base_url('index.php/Shoping_cart') ?>">Features</a>
                        </li>
